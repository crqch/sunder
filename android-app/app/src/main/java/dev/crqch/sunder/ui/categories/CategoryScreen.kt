...
fun CategoryScreen(
    ...
    val categoryFormState = viewModel.categoryFormState
                ...
                if (viewModel.isEditMode) {
                    ...
                    Column(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = { viewModel.updateForm(categoryFormState.copy(title = it)) },
